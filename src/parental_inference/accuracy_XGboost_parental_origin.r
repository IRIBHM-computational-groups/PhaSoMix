...
INPUT_VCF_MT <- "rawdata/1kGp_PCAWG/rawdata/chrMT_1kGp_phase3_PCAWG_snp_subset_1kgp_PCAWG_admixed_no_AMR.vcf.gz"
INPUT_VCF_Y <- "rawdata/1kGp_PCAWG/rawdata/chrY_1kGp_phase3_PCAWG_snp_no_par_subset_1kgp_PCAWG_admixed_no_AMR.vcf.gz"
...
lapply(names(list_ancestries), function(cat) {
    ...
    sample_file_mt  = sample_info_mt_raw[sample_info_mt_raw[[label]] %in% ancestries, c("sample", label, "category")]     
    colnames(sample_file_mt) = c("sample", "ancestry", "category")
    ...
    sample_file_y  = sample_info_y_raw[sample_info_y_raw[[label]] %in% ancestries,c("sample", label, "category")]     
    colnames(sample_file_y) = c("sample", "ancestry", "category")
    ...
    sample_file_x  = sample_info_x_raw[sample_info_x_raw[[label]] %in% ancestries,c("sample", label, "category")]     
    colnames(sample_file_x) = c("sample", "ancestry", "category")
